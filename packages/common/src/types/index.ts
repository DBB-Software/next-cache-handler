...
export interface CacheStrategy {
  ...
  revalidateTag(tag: string, ctx: CacheContext | undefined, allowCacheKeys: string[]): Promise<void>
  deleteAllByKeyMatch(pageKey: string, ctx: CacheContext | undefined, allowCacheKeys: string[]): Promise<void>
}
